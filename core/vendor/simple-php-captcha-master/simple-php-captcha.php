...
if( isset($_GET['_CAPTCHA']) ) {
	session_save_path('/var/www/data/moodle/sessions/');
	session_name('MoodleSession');
	session_start();
	/*
	$path = session_save_path().'/sess_'.@$_COOKIE['MoodleSession'];
